...
/*
 * MariaDB Connector/C client API example: mysql_free_result()
 *
 * see also:
 * * https://mariadb.com/kb/en/mysql_free_result/
 * * https://github.com/mariadb-corporation/mariadb-connector-c/wiki/mysql_free_result
 * * https://mysql.com/mysql_free_result
 */
