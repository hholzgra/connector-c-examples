 ...
 *
 * see also:
 * * https://mariadb.com/kb/en/mysql_get_host_info/
 * * https://github.com/mariadb-corporation/mariadb-connector-c/wiki/mysql_get_host_info
 * * https://mysql.com/mysql_get_host_info
 */
