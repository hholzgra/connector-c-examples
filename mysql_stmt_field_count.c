...
/*
 * MariaDB Connector/C client API example: mysql_stmt_field_count()
 *
 * see also:
 * * https://mariadb.com/kb/en/mysql_stmt_field_count/
 * * https://github.com/mariadb-corporation/mariadb-connector-c/wiki/mysql_stmt_field_count
 * * https://mysql.com/mysql_stmt_field_count
 */
